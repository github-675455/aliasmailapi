...
namespace AliasMailApi.Migrations
{
    ...
    [Migration("20191218022910_notification-beta")]
    partial class notificationbeta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AliasMailApi.Models.Domain", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Created = new DateTimeOffset(new DateTime(2019, 12, 17, 23, 29, 10, 125, DateTimeKind.Unspecified).AddTicks(5630), new TimeSpan(0, -3, 0, 0, 0)),
                            Description = "",
            ...
            modelBuilder.Entity("aliasmailapi.Models.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("aliasmailapi.Models.DeviceSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
                    ...
                    b.ToTable("DevicesSubscriptions");
                });

            modelBuilder.Entity("aliasmailapi.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("aliasmailapi.Models.UserDevice", b =>
                {
            ...
            modelBuilder.Entity("aliasmailapi.Models.UserDevice", b =>
                {
                    b.HasOne("aliasmailapi.Models.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("aliasmailapi.Models.User", "User")
                        .WithMany()
